...
/**
 * Servlet implementation class UserInquiryInsertServlet
 */
public class UserInquiryInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UserInquiryInsertServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		if (error) {
			...
			if (new UserInquiryDAO().addUsertInquiry(bean)) {
				request.setAttribute("msginsert", "Inserted");
