...
<%@ include file="AdminSideBar.jsp" %>
	...
	<form action="TrainerValidateServlet?id=${param.id}" method="post">
		<div class="w3-animate-left w3-container w3-half" style="margin-top: 20px;">
			<div class="w3-row">
				<label class="w3-col m3"> Name </label> 
				<div class="w3-col m4">
					<input required   type="text" name="firstName" id="firstName"
					placeholder="First Name" class="w3-input"  value="${trainerBean.firstName}"  />

				</div>

				<div class="w3-col s1">&emsp;</div>

				<div class="w3-col m4"> <input required   type="text" name="lastName" value="${trainerBean.lastName}"
			...
			<div class="w3-row">
				<label class="w3-col m3"> Email</label> <div class="w3-col m9">
					<input required   type="email" name="email" readonly="readonly" id="email" value="${trainerBean.email}"
			...
			<div class="w3-row">
				<label class="w3-col m3"> Experience</label> <div class="w3-col m9">
					<input required   type="number" name="experiance" id="experience" value="${trainerBean.experiance}"
					placeholder="Experience" class="w3-input" />
				</div>
			</div>
			<br />
			...
			<div class="w3-row">
				...
				<div class="w3-col m9">
					<input required   type="password" placeholder="Create Password" readonly="readonly" value="${trainerBean.password}"
			...
			<div class="w3-row">
				...
				<div class="w3-col m9">
					<input required   type="text" class="w3-input" name="city" value="${trainerBean.city}"
