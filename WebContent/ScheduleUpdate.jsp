...
<div class="w3-half w3-container " >
	 <div class="w3-row" >
		...
		ScheduleBean scheduleBean=(ScheduleBean)request.getAttribute("scheduleBean");
			ArrayList<ScheduleTimeBean> listofscheduleTime=new ScheduleTimeDAO().getScheduleTimeList();
			for(int i=0;i<listofscheduleTime.size();i++)
			{
				ScheduleTimeBean scheduleTimeBean=(ScheduleTimeBean)listofscheduleTime.get(i);
				String ac=scheduleBean.getStartTime();
	...
	%>
	 ...
	 <div class="w3-row" >
		...
		<div class="w3-col m4">
			...
			{
				ScheduleTimeBean scheduleTimeBean=(ScheduleTimeBean)listofscheduleTime.get(i);
				String ac=scheduleBean.getEndTime();
				String tmp="unselected";
	...
	<option value="-1">Select Activity</option>
			...
			for(int i=0;i<listofactivity.size();i++)
			{
				...
				String ac=scheduleBean.getActivity();
				String tmp="unselected";
	...
	<div class="w3-row">
		...
		<div class="w3-col m4">
			<%
			String s[]={"unselected","unselected","unselected","unselected","unselected","unselected"
					,"unselected","unselected"
			};
			String ac=scheduleBean.getDay()+"";
			if(ac!=null)
